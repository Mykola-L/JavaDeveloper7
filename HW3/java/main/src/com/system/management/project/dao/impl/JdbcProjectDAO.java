package com.system.management.project.dao.impl;
...
import com.system.management.project.works.WorkDao;
...
public class JdbcProjectDAO implements IProjectDAO {
    ...
    public JdbcProjectDAO(Connection connection) throws SQLException {
        ...
        companyDAO = WorkDao.getCompanyDAO();
        customerDAO = WorkDao.getCustomerDAO();
    }
